...
class RefreshTokenUseCase(private val preferencesRepository: PreferencesRepository) :
    DataUseCase<String, Flow<Result<String?>>> {

    override fun get() = preferencesRepository.getRefreshToken().asPreferenceResult()

    override suspend fun set(params: String) {
        preferencesRepository.setRefreshToken(params)
    }
}
